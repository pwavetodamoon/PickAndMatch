...
namespace Skywatch.AssetManagement
{
    ...
    public static class AssetManager
    {
        ...
        static readonly Dictionary<string, List<object>> _loadedLableAssets = new Dictionary<string, List<object>>();
        ...
        public static AsyncOperationHandle<List<object>> LoadAssetsByLabelAsync(string label)
        {
            var handle = Addressables.ResourceManager.StartOperation(new LoadAssetsByLabelOperation(_loadedAssets, _loadingAssets,_loadedLableAssets, label, AssetLoadedCallback), default);
            return handle;
        }
        public static AsyncOperationHandle<IList<IResourceLocation>> GetUnLoadAssetsByLabelAsync(string label)
        {
            var handle = Addressables.ResourceManager.StartOperation(new UnLoadAssetsByLabelOperation(_loadedAssets, _loadingAssets, label, AssetLoadedCallback), default);
            return handle;
        }
